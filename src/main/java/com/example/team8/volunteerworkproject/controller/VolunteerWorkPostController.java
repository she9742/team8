...
import com.example.team8.volunteerworkproject.enums.UserRoleEnum;
...
import com.example.team8.volunteerworkproject.service.VolunteerWorkPostServiceImpl;
...
public class VolunteerWorkPostController {
  ...
  //게시글 삭제
  @Secured({UserRoleEnum.Authority.COMPANY, UserRoleEnum.Authority.ADMIN})
